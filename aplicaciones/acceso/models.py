...
class Cargos(models.Model):
	...
	def __str__(self):
		return f'{self.cargo}, {self.descripcion}'
...
class Programacion(models.Model):
	...
	def __str__(self):
		return f'{self.semana}, {self.fecha}'
...
class Labores(models.Model):
	...
	def __str__(self):
		return f'{self.labor}, {self.descripcion}'

class Procesos(models.Model):
	proceso       = models.CharField('Proceso:', max_length = 60, null = False, blank = False)
	...
	def __str__(self):
		return f'{self.proceso} {self.descripcion}'
...
class DetalleProgramacion(models.Model):
	...
	def __str__(self):
		return f'{self.programacion}, {self.empleado}, {self.labor}, {self.proceso}'
...
class FuncionesEmpleados(models.Model):
	...
	def __str__(self):
		return f'{self.funcion}, {self.descripcion}'
...
class FuncionesXEmpleados(models.Model):
	...
	def __str__(self):
		return f'{self.funcion}, {self.empleado}'
...
class Visitantes(models.Model):
	...
	def __str__(self):
		return f'{self.nit_cedula}, {self.nombre_apellido}'
...
class EntradaVehiculos(models.Model):
	...
	def __str__(self):
		return f'{self.visitante}, {self.placa_vehiculo}'